...
import com.ballisticapps.aitoolbox.reward_ads_feature.data.repository.AdManagerRepositoryImpl
...
object AdMobModule {
    ...
    fun provideAdManagerRepository(@ApplicationContext context: Context): AdManagerRepository {
        return AdManagerRepositoryImpl(context, "ca-app-pub-8710979310678386/4244404674")
    }
}